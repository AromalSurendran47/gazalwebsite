    ...
    <div className='min-h-screen bg-black text-white font-[font1] overflow-hidden relative'>
      ...
      <div className='h-screen w-full flex flex-col justify-between px-5 lg:px-12 py-8 lg:py-12'>
        ...
        <div className='flex-1 flex items-center justify-center relative pt-20 lg:pt-0'>
          ...
          >
            <p>In a screen or desktop.</p>
            <p>At your place. At our place.</p>
            <p>Everywhere.</p>
          </div>
          ...
          <div 
            ref={rightTextRef}
            className='absolute right-0 lg:right-12 top-1/2 -translate-y-1/2 lg:w-64 w-40 text-xs lg:text-base leading-relaxed text-right hidden lg:block'
          >
            <p>525 BC. Viger O - Suite 400</p>
          ...
          <div className='lg:hidden absolute bottom-0 left-0 right-0 flex justify-between px-5 text-xs'>
            ...
            <div ref={rightTextMobileRef} className='text-right'>
              <p>525 BC. Viger O - Suite 400</p>
              <p>Montreal, QC H2Z 1G6</p>
              <p className='mt-2'>→</p>
            </div>
        ...
        <div className='relative w-full overflow-hidden my-8 lg:my-12'>
          ...
          >
            <div className='absolute inset-0 flex items-center justify-center lg:justify-start lg:pl-12 rotate-3 overflow-hidden'>
              <div className='flex'>
                <div className='moveX flex items-center'>
                  <div className='text-black font-[font2] text-4xl lg:text-6xl xl:text-7xl uppercase flex items-center whitespace-nowrap px-4 lg:px-8'>
                    <span className='inline-block'>♥</span> BONJOUR.CA
                  </div>
                  <div className='text-black font-[font2] text-4xl lg:text-6xl xl:text-7xl uppercase flex items-center whitespace-nowrap px-4 lg:px-8'>
                    <span className='inline-block'>♥</span> BONJOUR.CA
                  </div>
        ...
        >
          <div className='text-sm lg:text-base uppercase tracking-wider'>FOLLOW US</div>
